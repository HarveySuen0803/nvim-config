...
-- map('n', '<S-CR>', ":call VSCodeNotify('editor.action.smartSelect.shrink')<CR>", opt)
...
map("n", "z]", ":call VSCodeNotify('workbench.action.closeEditorsToTheRight')<CR>", opt)
map("n", "z[", ":call VSCodeNotify('workbench.action.closeEditorsToTheLeft')<CR>", opt)
map("n", "z\\", ":call VSCodeNotify('workbench.action.closeOtherEditors')<CR>", opt)
...
map("n", "gD", ":call VSCodeNotify('editor.action.goToImplementation')<CR>", opt)
map("n", "gp", ":call VSCodeNotify('editor.action.goToTypeDefinition')<CR>", opt)
...
map("v", "mh", ":call VSCodeNotify('editor.action.showHover')<CR>", opt)
...
map("n", "zk", ":call VSCodeNotify('workbench.action.focusAboveGroup')<CR>", opt)
map("n", "zj", ":call VSCodeNotify('workbench.action.focusBelowGroup')<CR>", opt)
