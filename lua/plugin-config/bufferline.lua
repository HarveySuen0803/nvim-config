...
vim.api.nvim_set_keymap('n', 'z]', ':BufferLineCloseRight<CR>', {})
vim.api.nvim_set_keymap('n', 'z[', ':BufferLineCloseLeft<CR>', {})
vim.api.nvim_set_keymap('n', 'z\\', ':BufferLineCloseOthers<CR>', {})
